...
class Book(models.Model):
    name_author = models.CharField(max_length=100, null=False, blank=False,default='Name', verbose_name='Имя автора')
    email = models.EmailField(max_length=100, null=False, blank=False, default='EmailAdress',verbose_name='Почта')
